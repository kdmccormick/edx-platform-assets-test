(function(define, undefined) {
    'use strict';
    RequireJS.define('js/student_account/models/user_account_model',[
...
(function(define, undefined) {
    'use strict';
    RequireJS.define('js/student_account/models/user_preferences_model',[
        'gettext', 'underscore', 'backbone'
    ], function(gettext, _, Backbone) {
...
;(function (global, factory) {
    ...
    typeof RequireJS.define === 'function' && RequireJS.define.amd ? RequireJS.define('moment',factory) :
...
(function (root, factory) {
	...
	/*global define*/
	if (typeof RequireJS.define === 'function' && RequireJS.define.amd) {
		RequireJS.define('moment-timezone',['moment'], factory);                 // AMD
...
(function(define) {
    'use strict';
    RequireJS.define('edx-ui-toolkit/js/utils/date-utils',[
        'jquery',
        'moment',
        'moment-timezone'
    ], function(
    ...
    typeof RequireJS.define === 'function' && RequireJS.define.amd ? RequireJS.define :
...
(function(root, factory) {
  ...
  if (typeof RequireJS.define === 'function' && RequireJS.define.amd) {
    RequireJS.define('backbone-super',['underscore', 'backbone'], function(_, Backbone) {
...
(function(define, undef) {
    'use strict';
    RequireJS.define('js/views/fields',[
...
(function(define, undefined) {
    'use strict';
    RequireJS.define('js/student_account/views/account_settings_fields',[
        'gettext',
        'jquery',
        'underscore',
        'backbone',
...
(function(define) {
    'use strict';
    RequireJS.define('edx-ui-toolkit/js/utils/constants',[], function() {
        /**
         * Reusable constants.
         *
...
RequireJS.define('text!common/templates/components/tabbed_view.underscore',[],function () { return '<div class="page-content-nav" role="tablist"></div>\n<div class="page-content-main">\n    <div class="tabs"></div>\n</div>\n';});
...
(function(define) {
    ...
    RequireJS.define('common/js/components/views/tabbed_view',[
        'backbone',
        'underscore',
        'jquery',
...
(function(define, undefined) {
    'use strict';
    RequireJS.define('js/student_account/views/account_settings_factory',[
