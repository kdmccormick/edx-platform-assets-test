...
var Currency = /*#__PURE__*/function () {
  ...
  _createClass(Currency, [{
    key: "editText",
    value: // eslint-disable-line import/prefer-default-export
    function editText(price) {
      ...
      if (regexMatch) {
        ...
        var newPriceString = "".concat(l10nCookie.symbol).concat(Math.round(newPrice), " ").concat(l10nCookie.code); // Change displayed price based on edx-price-l10n cookie currency_data
    ...
    value: function setPrice() {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()('.upgrade-price-string').each(function (i, price) {
        ...
        _this2.editText(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(price));
      });
    }
  }, {
    key: "getCountry",
