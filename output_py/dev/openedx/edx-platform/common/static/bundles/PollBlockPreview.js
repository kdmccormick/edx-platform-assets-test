...
(function () {
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./xmodule/js/src/poll/poll_main.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (PollMain) {
    'use strict';
...
(function () {
  !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/edx-ui-toolkit/src/js/utils/html-utils.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (HtmlUtils) {
    PollMain.prototype = {
      showAnswerGraph: function showAnswerGraph(poll_answers, total) {
        ...
        $.each(poll_answers, function (index, value) {
          ...
          _this.answersObj[index].statsEl.show(); // eslint-disable-next-line max-len
      ...
      submitAnswer: function submitAnswer(answer, answerObj) {
        var _this; // Make sure that the user can answer a question only once.
        ...
        answerObj.buttonEl.addClass('answered'); // Send the data to the server as an AJAX request. Attach a callback that will
      ...
      submitReset: function submitReset() {
        ...
        _this = this;
        console.log('submit reset'); // Send the data to the server as an AJAX request. Attach a callback that will
        // be fired on server's response.
        ...
        $.postWithPrefix(this.ajax_url + '/' + 'reset_poll', {}, function (response) {
          ...
          _this.resetButton.hide(); // Initialize Conditional constructors. We will specify the third parameter as 'true'
      ...
      postInit: function postInit() {
        var _this; // Access this object inside inner functions.
        ...
        this.id = this.questionEl.attr('id'); // Get the URL to which we will post the users answer to the question.
        ...
        this.questionEl.append(HtmlUtils.HTML(this.questionHtmlMarkup).toString()); // When the user selects and answer, we will set this flag to true.
    ...
    function PollMain(el, runtime) {
      ...
      this.questionEl.attr('poll_main_processed', 'true'); // Access this object inside inner functions.

      _this = this; // DOM element which contains the current poll along with any conditionals. By default we assume that such
...
/* WEBPACK VAR INJECTION */(function($, jQuery) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/edx-ui-toolkit/src/js/utils/html-utils.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (HtmlUtils) {
  PollMain.prototype = {
    showAnswerGraph: function showAnswerGraph(poll_answers, total) {
      var _this, totalValue;
