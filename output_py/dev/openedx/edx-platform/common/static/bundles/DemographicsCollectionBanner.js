(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([3,4,12],{
...
var DemographicsCollectionBanner = /*#__PURE__*/function (_React$Component) {
  _inherits(DemographicsCollectionBanner, _React$Component);

  var _super = _createSuper(DemographicsCollectionBanner);
  ...
  function DemographicsCollectionBanner(props) {
    ...
    _this.dismissBanner = _this.dismissBanner.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
  ...
  _createClass(DemographicsCollectionBanner, [{
    key: "dismissBanner",
    value: function () {
      var _dismissBanner = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
        var requestOptions;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return fetch("".concat(this.props.lmsRootUrl, "/api/demographics/v1/demographics/status/"), requestOptions);
      ...
      function dismissBanner(_x) {
        return _dismissBanner.apply(this, arguments);
      }
    ...
    value: function render() {
      ...
      if (!this.state.hideBanner) {
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a", {
          id: "demographics-banner-link",
          className: "btn",
          ...
          className: "demographics-banner-icon d-none d-lg-inline-block",
          src: this.props.bannerLogo,
          alt: "",
          "aria-hidden": "true"
        }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "demographics-banner-prompt d-inline-block font-weight-bold text-white mr-4 py-3 px-2 px-lg-3"
        }, gettext('Want to make edX better for everyone?')), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
          ...
          className: "fa fa-thumbs-up px-2",
          "aria-hidden": "true"
        }), gettext('Get started'))), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          ...
          type: "button",
          className: "demographics-dismiss-btn btn btn-default px-0",
          id: "demographics-dismiss",
          "aria-label": "close"
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", {
          className: "fa fa-times-circle text-white px-2",
          "aria-hidden": "true",
          onClick: this.dismissBanner
        }))))), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, this.state.modalOpen && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__DemographicsCollectionModal__["DemographicsCollectionModal"], _extends({}, this.props, {
...
var DemographicsCollectionModal = /*#__PURE__*/function (_React$Component) {
  _inherits(DemographicsCollectionModal, _React$Component);

  var _super = _createSuper(DemographicsCollectionModal);
  ...
  function DemographicsCollectionModal(props) {
    ...
    _this.getDemographicsQuestionOptions = _this.getDemographicsQuestionOptions.bind(_assertThisInitialized(_this));
    _this.getDemographicsData = _this.getDemographicsData.bind(_assertThisInitialized(_this)); // Get JWT token service to ensure the JWT token refreshes if needed

    var accessToken = _this.props.jwtAuthToken;
    var refreshUrl = "".concat(_this.props.lmsRootUrl, "/login_refresh");
  ...
  _createClass(DemographicsCollectionModal, [{
    ...
    value: function loadOptions(field) {
      var _get = __WEBPACK_IMPORTED_MODULE_1_lodash_get___default()(this.state.options, field, {
        choices: []
      }),
    ...
    value: function () {
      var _handleSelectChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var url, name, value, options;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                url = "".concat(this.props.demographicsBaseUrl, "/demographics/api/v1/demographics/").concat(this.props.user, "/");
                name = e.target.name;
              ...
              case 21:
                this.setState(function (prevState) {
                  return {
                    selected: _objectSpread(_objectSpread({}, prevState.selected), {}, _defineProperty({}, name, value))
                  };
                });
    ...
    value: function handleMultiselectChange(values) {
      ...
      this.setState(function (_ref) {
        ...
        if (selected[FIELD_NAMES.ETHNICITY].find(function (i) {
          ...
          return {
            selected: _objectSpread(_objectSpread({}, selected), {}, _defineProperty({}, FIELD_NAMES.ETHNICITY, values.filter(function (value) {
              return value !== 'declined';
            })))
          }; // decline was just selected
        } else if (decline) {
          return {
            selected: _objectSpread(_objectSpread({}, selected), {}, _defineProperty({}, FIELD_NAMES.ETHNICITY, [decline]))
          }; // anything else was selected
        } else {
          return {
            selected: _objectSpread(_objectSpread({}, selected), {}, _defineProperty({}, FIELD_NAMES.ETHNICITY, values))
          };
        }
      });
    }
    ...
    value: function () {
      var _retrieveDemographicsCsrfToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(url) {
        var csrfToken;
      ...
      function retrieveDemographicsCsrfToken(_x2) {
        return _retrieveDemographicsCsrfToken.apply(this, arguments);
      }
    ...
    value: function () {
      var _getDemographicsQuestionOptions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return fetch("".concat(this.props.demographicsBaseUrl, "/demographics/api/v1/demographics/"), {
                  method: 'OPTIONS'
                });
      ...
      function getDemographicsQuestionOptions() {
        return _getDemographicsQuestionOptions.apply(this, arguments);
      }
    ...
    value: function () {
      var _getDemographicsData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                _context5.next = 6;
                return fetch("".concat(this.props.demographicsBaseUrl, "/demographics/api/v1/demographics/").concat(this.props.user, "/"), requestOptions);
      ...
      function getDemographicsData() {
        return _getDemographicsData.apply(this, arguments);
      }
    ...
    value: function () {
      var _createDemographicsEntry = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var postUrl, postOptions, postResponse, data;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                postUrl = "".concat(this.props.demographicsBaseUrl, "/demographics/api/v1/demographics/");
                _context6.next = 3;
      ...
      function createDemographicsEntry() {
        return _createDemographicsEntry.apply(this, arguments);
      }
    ...
    value: function render() {
      ...
      return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_react_focus_lock__["a" /* default */], null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "demographics-collection-modal d-flex justify-content-center align-items-start"
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */], {
        onWizardComplete: this.props.closeModal,
        dismissBanner: this.props.dismissBanner,
        wizardContext: _objectSpread(_objectSpread({}, this.state.selected), {}, {
          options: this.state.options
        }),
        error: this.state.error
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].Header, null, function (_ref2) {
        var currentPage = _ref2.currentPage,
            totalPages = _ref2.totalPages;
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        ...
        }, gettext('Help make edX better for everyone!')), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
          className: "message"
        }, gettext('Welcome to edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.')), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", {
          "aria-hidden": "true",
          ...
          target: "_blank",
          rel: "noopener",
          href: "".concat(_this2.props.marketingSiteBaseUrl, "/demographics").replace(/"/g, "")
        }, gettext('Why does edX collect this information?')), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null), _this2.state.fieldError && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
          className: "field-error"
        }, gettext("An error occurred while attempting to retrieve or save the information below. Please try again later.")));
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].Page, null, function (_ref3) {
        var wizardConsumer = _ref3.wizardConsumer;
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "demographics-form-container",
          "data-hj-suppress": true
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__SelectWithInput__["a" /* SelectWithInput */], {
          ...
          options: [/*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("option", {
            value: "default",
            key: "default"
          }, gettext("Select gender")), _this2.loadOptions(FIELD_NAMES.GENDER)],
        ...
        }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__MultiselectDropdown__["a" /* MultiselectDropdown */], {
          label: gettext("Which of the following describes you best?"),
          emptyLabel: gettext("Check all that apply"),
          options: __WEBPACK_IMPORTED_MODULE_1_lodash_get___default()(_this2.state.options, FIELD_NAMES.ETHNICITY_OPTIONS, {
            choices: []
          }).choices,
        ...
        }, gettext("What was the total combined income, during the last 12 months, of all members of your family? ")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
          ...
          value: "default"
        }, gettext("Select income")), _this2.loadOptions(FIELD_NAMES.INCOME))));
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].Page, null, function (_ref4) {
        var wizardConsumer = _ref4.wizardConsumer;
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "demographics-form-container",
          "data-hj-suppress": true
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        }, gettext("Have you ever served on active duty in the U.S. Armed Forces, Reserves, or National Guard?")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
          autoFocus: true,
          className: "form-control",
          onChange: _this2.handleSelectChange,
          ...
          value: "default"
        }, gettext("Select military status")), _this2.loadOptions(FIELD_NAMES.MILITARY))));
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].Page, null, function (_ref5) {
        var wizardConsumer = _ref5.wizardConsumer;
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "demographics-form-container",
          "data-hj-suppress": true
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        }, gettext("What is the highest level of education that you have achieved so far?")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
          className: "form-control",
          autoFocus: true,
          onChange: _this2.handleSelectChange,
          key: "self-education",
          ...
          value: "default"
        }, gettext("Select level of education")), _this2.loadOptions(FIELD_NAMES.EDUCATION_LEVEL))), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "d-flex flex-column pb-3"
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", {
          htmlFor: FIELD_NAMES.PARENT_EDUCATION
        }, gettext("What is the highest level of education that any of your parents or guardians have achieved?")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
          className: "form-control",
          onChange: _this2.handleSelectChange,
          ...
          value: "default"
        }, gettext("Select guardian education")), _this2.loadOptions(FIELD_NAMES.PARENT_EDUCATION))));
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].Page, null, function (_ref6) {
        var wizardConsumer = _ref6.wizardConsumer;
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "demographics-form-container",
          "data-hj-suppress": true
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__SelectWithInput__["a" /* SelectWithInput */], {
          ...
          options: [/*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("option", {
            value: "default",
            key: "default"
          }, gettext("Select employment status")), _this2.loadOptions(FIELD_NAMES.WORK_STATUS)],
        ...
        }, gettext("What industry do you currently work in?")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
          className: "form-control",
          onChange: _this2.handleSelectChange,
          ...
          value: "default"
        }, gettext("Select current industry")), _this2.loadOptions(FIELD_NAMES.CURRENT_WORK))), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          className: "d-flex flex-column pb-3"
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", {
          htmlFor: FIELD_NAMES.FUTURE_WORK
        }, gettext("What industry do you want to work in?")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
          className: "form-control",
          onChange: _this2.handleSelectChange,
          ...
          value: "default"
        }, gettext("Select prospective industry")), _this2.loadOptions(FIELD_NAMES.FUTURE_WORK))));
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].Closer, null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "demographics-modal-closer m-sm-0"
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", {
        className: "fa fa-check",
        "aria-hidden": "true"
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h3", null, gettext("Thank you! You’re helping make edX better for everyone.")))), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Wizard__["a" /* default */].ErrorPage, null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, this.state.error.length ? this.state.error : gettext("An error occurred while attempting to retrieve or save the information below. Please try again later."))))));
    }
  }]);
...
var MultiselectDropdown = /*#__PURE__*/function (_React$Component) {
  ...
  function MultiselectDropdown(props) {
    ...
    _this.handleRemoveAllClick = _this.handleRemoveAllClick.bind(_assertThisInitialized(_this));
  ...
  _createClass(MultiselectDropdown, [{
    ...
    value: function handleOptionClick(e) {
      ...
      var newSelected = _toConsumableArray(this.props.selected); // if the option has its own onChange, trigger that instead
    ...
    value: function renderUnselect() {
      return this.props.selected.length > 0 && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        id: "unselect-button",
    ...
    value: function renderMenu() {
      ...
      var options = this.props.options.map(function (option, index) {
        ...
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
          key: index,
          id: "".concat(option.value, "-option-container"),
          className: "option-container"
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", {
          className: "option-label"
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", {
          id: "".concat(option.value, "-option-checkbox"),
          className: "option-checkbox",
          type: "checkbox",
          value: option.value,
          checked: checked,
          onChange: _this3.handleOptionClick
        }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", {
          className: "pl-2"
        }, option.display_name)));
      });
      return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("fieldset", {
        id: "multiselect-dropdown-fieldset",
        disabled: this.props.disabled
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("legend", {
        className: "sr-only"
    ...
    value: function render() {
      ...
      return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
      ...
      }, this.props.label), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        "aria-labelledby": "multiselect-dropdown-label multiselect-dropdown-button",
        onClick: this.handleButtonClick
      }, this.renderSelected()), this.renderUnselect()), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, this.renderMenu()));
    }
  }]);
...
var SelectWithInput = function SelectWithInput(props) {
  ...
  return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
    ...
    htmlFor: selectName
  }, labelText), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("select", {
    autoFocus: true,
    className: "form-control",
    name: selectName,
    id: selectId,
    ...
    value: selectValue,
    disabled: disabled
  }, options), showInput && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", {
    className: "form-control",
    "aria-label": "".concat(selectName, " description field"),
    type: inputType,
    name: inputName,
    id: inputId,
...
var Wizard = /*#__PURE__*/function (_React$Component) {
  ...
  function Wizard(props) {
    ...
    _this = _super.call(this, props);
    _this.findSubComponentByType = _this.findSubComponentByType.bind(_assertThisInitialized(_this));
    ...
    _this.wizardComplete = _this.wizardComplete.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(Wizard, [{
    ...
    value: function renderPage() {
      if (this.state.totalPages) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(page.props.children)) {
          return page.props.children({
            wizardConsumer: this.props.wizardContext
          });
        } else {
          return page.props.children;
        }
    ...
    value: function renderError() {
      ...
      return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        role: "dialog",
        "aria-label": gettext("demographics questionnaire")
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wizard-header"
      }, errorPage.props.children), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wizard-footer justify-content-end h-100 d-flex flex-column"
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        className: "wizard-button colored",
        "arial-label": gettext("close questionnaire"),
        onClick: this.props.onWizardComplete
      }, gettext("Close"))));
    }
    /**
    ...
    key: "wizardComplete",
    value: function () {
      var _wizardComplete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
      ...
      function wizardComplete() {
        return _wizardComplete.apply(this, arguments);
      }
    ...
    value: function render() {
      ...
      }, this.state.totalPages >= this.state.currentPage && this.renderHeader()), this.renderPage(), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "wizard-footer justify-content-end h-100 d-flex flex-column"
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        className: "wizard-button ".concat(finalPage && 'colored'),
        onClick: this.wizardComplete,
        "aria-label": gettext("finish later")
      }, finalPage ? gettext("Return to my dashboard") : gettext("Finish later")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        className: "wizard-button colored",
        hidden: finalPage,
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AxiosCsrfTokenService; });
...
var AxiosCsrfTokenService = /*#__PURE__*/function () {
  function AxiosCsrfTokenService(csrfTokenApiPath) {
    ...
    this.httpClient = __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create(); // Set withCredentials to true. Enables cross-site Access-Control requests
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AxiosJwtTokenService; });
...
var AxiosJwtTokenService = /*#__PURE__*/function () {
  function AxiosJwtTokenService(tokenCookieName, tokenRefreshEndpoint) {
    ...
    this.httpClient = __WEBPACK_IMPORTED_MODULE_2_axios___default.a.create(); // Set withCredentials to true. Enables cross-site Access-Control requests
    // to be made using cookies, authorization headers or TLS client
    // certificates. More on MDN:
    // https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/withCredentials
    ...
    this.httpClient.interceptors.response.use(function (response) {
      return response;
    }, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__interceptors_createRetryInterceptor__["a" /* default */])({
...
var createRetryInterceptor = function createRetryInterceptor() {
  ...
  var _options$httpClient = options.httpClient,
      httpClient = _options$httpClient === void 0 ? __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create() : _options$httpClient,
  ...
  return function wrap(WrappedComponent) {
    ...
    var SideEffect = /*#__PURE__*/function (_PureComponent) {
      ...
      _proto.render = function render() {
        return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_2_react___default.a.createElement(WrappedComponent, this.props);
      };
...
if (true) {
  ...
  var has = __webpack_require__("./node_modules/react-focus-lock/node_modules/prop-types/lib/has.js");
...
/***/ "./node_modules/react-focus-lock/node_modules/prop-types/lib/has.js":
/***/ (function(module, exports) {
