      ...
      function HTMLEditingDescriptor(element) {
        ...
        if (this.editor_choice === 'visual') {
          ...
          if (typeof process != "undefined" && undefined) {
            var tinyMceAdditionalPlugins = undefined.TINYMCE_ADDITIONAL_PLUGINS; // check if we have any additional plugins passed
            ...
            if (tinyMceAdditionalPlugins) {
              ...
              tinyMceAdditionalPlugins.forEach(function (tinyMcePlugin) {
                ...
                tinyMceConfig.plugins += tinyMcePlugin.name; // check if the plugin should be included in the toolbar
            ...
            var tinyMceConfigOverrides = undefined.TINYMCE_CONFIG_OVERRIDES;

            if (tinyMceConfigOverrides) {
              _extends(tinyMceConfig, tinyMceConfigOverrides);
            }
          }
...
module.exports = __webpack_require__("./common/static/xmodule/descriptors/js/001-19c4723cecaa5a5a46b8566b3544e732.js");
