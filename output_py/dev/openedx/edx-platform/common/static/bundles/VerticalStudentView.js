(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([26,56],{
...
var ElementViewing = /*#__PURE__*/function () {
  /**
  ...
  _createClass(ElementViewing, [{
    ...
    value: function handleVisible() {
      ...
      if (!this.becameVisibleAt) {
        this.becameVisibleAt = Date.now(); // We're now visible; after viewedAfterMs, if the top and bottom have been
    ...
    value: function checkIfViewed() {
      ...
      if (this.areViewedCriteriaMet()) {
        this.hasBeenViewed = true; // Report to the tracker that we have been viewed
...
var ViewedEventTracker = /*#__PURE__*/function () {
  /**
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3), __webpack_require__(0), __webpack_require__(1), __webpack_require__(2), __webpack_require__("./lms/static/js/views/message_banner.js")], __WEBPACK_AMD_DEFINE_RESULT__ = function (gettext, $, _, Backbone, MessageBannerView) {
  return Backbone.View.extend({
    ...
    showError: function showError(errorText) {
      ...
      this.messageView.showMessage(errorMsg); // Hide message automatically after some interval
...
/***/ "./xmodule/assets/vertical/public/js/vertical_student_view.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* global Set:false */
// false means do not assign to Set
