...
var RightIcon = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Icon"], {
  className: ['fa', 'fa-arrow-right'],
  screenReaderText: gettext('View child items')
});
var UpIcon = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Icon"], {
...
var BlockList = function BlockList(_ref) {
  ...
  return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement("ul", {
    ...
    return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement("li", {
      key: block.id,
      className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()("block-type-".concat(block.type), {
        selected: block.id === selectedBlock
      })
    }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Button"], {
      className: ['block-name'],
      onClick: function onClick() {
        return onSelectBlock(block.id);
      },
      label: block.display_name
    }), block.children && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Button"], {
      onClick: function onClick() {
...
var BlockBrowser = function BlockBrowser(_ref2) {
  ...
  return !!blocks && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement("div", {
    ...
    className: "title"
  }, gettext('Browsing'), " ", gettext(BLOCK_TYPE_NAME[blocks.type]), " \"", /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement("a", {
    href: "#_",
    onClick: function onClick(event) {
      event.preventDefault();
      onSelectBlock(blocks.id);
    },
    title: "".concat(gettext('Select'), " ").concat(gettext(BLOCK_TYPE_NAME[blocks.type]))
  }, blocks.display_name), "\":")), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(BlockList, {
...
var getCourseBlocks = function getCourseBlocks(courseId) {
  return fetch("".concat(COURSE_BLOCKS_API, "?").concat(buildQueryString({
    course_id: courseId,
    all_blocks: true,
    depth: 'all',
...
var Main = /*#__PURE__*/function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.initiateReportGeneration = _this.initiateReportGeneration.bind(_assertThisInitialized(_this));
    _this.state = {
      showDropdown: false
    };
    return _this;
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _onSelectBlock = _this$props.onSelectBlock;
      var selectorType = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Button"], {
      ...
      if (this.props.showBtnUi === 'false') {
        ...
        __WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("span", {
          onClick: this.handleToggleDropdown,
          className: ['problem-selector']
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("span", null, selectedBlock || 'Select a section or problem'), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("span", {
          className: ['pull-right']
        }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Icon"], {
          className: ['fa', 'fa-sort']
        })));
      }

      return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", {
      ...
      }, selectorType, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("input", {
        type: "text",
        name: "problem-location",
        value: selectedBlock,
        disabled: true,
        hidden: this.props.showBtnUi === 'false'
      }), this.state.showDropdown && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_BlockBrowser_components_BlockBrowser_BlockBrowserContainer__["a" /* default */], {
        onSelectBlock: function onSelectBlock(blockId) {
          _this2.hideDropdown();

          _onSelectBlock(blockId);
        }
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Button"], {
        onClick: this.initiateReportGeneration,
        name: "list-problem-responses-csv",
        label: gettext('Create a report of problem responses')
      }), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_4__ReportStatus_ReportStatusContainer__["a" /* ReportStatusContainer */], null)));
    }
  }]);
...
var ReportStatus = function ReportStatus(_ref) {
  ...
  var progressMessage = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", {
    className: "msg progress"
  }, gettext('Your report is being generated...'), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Icon"], {
    hidden: true,
    className: ['fa', 'fa-refresh', 'fa-spin', 'fa-fw']
  }));
  var successMessage = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", {
    className: "msg success"
  }, gettext('Your report has been successfully generated.'), reportPath && /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("a", {
    href: reportPath
  }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0__edx_paragon__["Icon"], {
    hidden: true,
    className: ['fa', 'fa-link']
  }), gettext('View Report')));
  var errorMessage = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", {
    className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()('msg', {
      error: error
    })
  }, error && "".concat(gettext('Error'), ": "), error);
  return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_3_react__["createElement"]("div", {
...
var fetchTaskStatus = function fetchTaskStatus(endpoint, taskId) {
  return fetch("".concat(endpoint, "/?task_id=").concat(taskId), {
    credentials: 'same-origin',
    method: 'get',
    headers: HEADERS
  });
...
var ProblemBrowser = function ProblemBrowser(props) {
  ...
  }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_Main_MainContainer__["a" /* default */], props));
};
