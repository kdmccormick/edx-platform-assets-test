...
var EnterpriseLearnerPortalModal = /*#__PURE__*/function (_React$Component) {
  _inherits(EnterpriseLearnerPortalModal, _React$Component);

  var _super = _createSuper(EnterpriseLearnerPortalModal);
  ...
  function EnterpriseLearnerPortalModal(props) {
    ...
    _this.handleModalBackdropClick = _this.handleModalBackdropClick.bind(_assertThisInitialized(_this));
    _this.handleEsc = _this.handleEsc.bind(_assertThisInitialized(_this));
    _this.handleLearnerPortalDashboardClick = _this.handleLearnerPortalDashboardClick.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(EnterpriseLearnerPortalModal, [{
    ...
    value: function componentDidMount() {
      var storageKey = "enterprise_learner_portal_modal__".concat(this.props.enterpriseCustomerUUID);
    ...
    key: "handleModalBackdropClick",
    value: function handleModalBackdropClick(e) {
    ...
    value: function getLearnerPortalUrl() {
      var baseUrlWithSlug = "".concat(this.props.enterpriseLearnerPortalBaseUrl, "/").concat(this.props.enterpriseCustomerSlug);
      return "".concat(baseUrlWithSlug, "?utm_source=lms_dashboard_modal");
    }
  }, {
    key: "handleLearnerPortalDashboardClick",
    value: function handleLearnerPortalDashboardClick(e) {
      var _this2 = this;
      ...
      setTimeout(function () {
        window.location.href = _this2.getLearnerPortalUrl();
      }, 300);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
      ...
      }, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_focus_lock__["a" /* default */], null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "modal-content p-4 bg-white",
        ref: function ref(node) {
          _this3.modalRef = node;
        }
      ...
      })), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null, __WEBPACK_IMPORTED_MODULE_2_edx_ui_toolkit_js_utils_string_utils___default.a.interpolate(gettext('To access the courses available to you through {enterpriseName}, visit the {enterpriseName} dashboard.'), {
        enterpriseName: this.props.enterpriseCustomerName
      })), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        ...
        onClick: function onClick() {
          window.analytics.track('edx.ui.enterprise.lms.dashboard.learner_portal_modal.closed', {
            enterpriseUUID: _this3.props.enterpriseCustomerUUID,
            source: 'Cancel button'
          });

          _this3.closeModal();
        }
      }, gettext('Cancel')), /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_focus_lock__["b" /* AutoFocusInside */], null, /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("a", {
