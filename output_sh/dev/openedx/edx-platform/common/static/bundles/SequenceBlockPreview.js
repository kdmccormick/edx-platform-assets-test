...
/***/ "./common/static/xmodule/modules/js/001-77af1014e3a3b6552a294d7816e5487b.js":
  ...
  (function () {
    ...
    this.Sequence = function () {
      ...
      Sequence.prototype.toggleArrows = function () {
        ...
        this.$('.sequence-nav-button').unbind('click'); // previous button

        isFirstTab = this.position === 1;
        previousButtonClass = '.sequence-nav-button.button-previous';
        this.updateButtonState(previousButtonClass, this.selectPrevious, isFirstTab, this.prevUrl); // next button
      ...
      Sequence.prototype.render = function (newPosition) {
        ...
        if (this.position !== newPosition) {
          ...
          bookmarked = this.el.find('.active .bookmark-icon').hasClass('bookmarked'); // update the data-attributes with latest contents only for updated problems.
          ...
          XBlock.initializeBlocks(this.content_container, this.requestToken); // For embedded circuit simulator exercises in 6.002x
      ...
      Sequence.prototype["goto"] = function (event) {
        ...
        event.preventDefault(); // Links from courseware <a class='seqnav' href='n'>...</a>, was .target_tab
        ...
        if ($(event.currentTarget).hasClass('seqnav')) {
          ...
          return true; // Tab links generated by backend template
        } else {
      ...
      Sequence.prototype._change_sequential = function (direction, event) {
        var analyticsEventName, isBottomNav, newPosition, offset, targetUrl, widgetPlacement; // silently abort if direction is invalid.
...
module.exports = __webpack_require__("./common/static/xmodule/modules/js/001-77af1014e3a3b6552a294d7816e5487b.js");
