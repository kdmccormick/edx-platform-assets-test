(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([27,28,29,30],{
...
(function () {
  var setupFullScreenModal = function setupFullScreenModal() {
    ...
    $('a.modal-content').each(function () {
      ...
      var largeImageSRC = $(this).attr('href'); // if contents of zoomable link is image and large image link exists: setup modal
      ...
      if (smallImageObject.is('img') && largeImageSRC) {
        ...
        var html = _.template($('#image-modal-tpl').text())(data); // xss-lint: disable=javascript-jquery-insertion
    ...
    $('.wrapper-modal-image .image-content .image-controls .modal-ui-icon').click(function () {
      if (!$(this).hasClass('is-disabled')) {
        ...
        if ($(this).hasClass('action-zoom-in')) {
          ...
          var imgContainerHeight = imgHeight + imgContainerOffsetTop; // Set the width and height of the image's container so that the dimensions are equal to the image dimensions + view area dimensions to limit dragging
...
(function () {
  ...
  (function (window, factory) {
    ...
    function Unipointer() {} // inherit EventEmitter
    ...
    Unipointer.prototype._unbindPostStartEvents = function () {
      var args = this._boundPointerEvents; // IE8 can trigger dragEnd twice, check for _boundEvents
    ...
    Unipointer.prototype.pointerDone = noop; // ----- pointer cancel ----- //
  ...
  (function (window, factory) {
    ...
    Unidragger.prototype.pointerDown = function (event, pointer) {
      this._dragPointerDown(event, pointer); // kludge to blur focused inputs in dragger
    ...
    Unidragger.prototype._dragPointerDown = function (event, pointer) {
      ...
      var targetNodeName = event.target.nodeName; // HACK iOS, allow clicks on buttons, inputs, and links, or children of links

      var isTouchstartNode = event.type == 'touchstart' && (allowTouchstartNodes[targetNodeName] || getParentLink(event.target)); // do not prevent default on touchstart nodes or <select>
    ...
    Unidragger.prototype._dragStart = function (event, pointer) {
      ...
      this.dragStartPoint = Unidragger.getPointerPoint(pointer); // prevent clicks
  ...
  (function (window, factory) {
    ...
    var transformProperty = getStyleProperty('transform'); // TODO fix quick & dirty check for 3D support
    ...
    Draggabilly.prototype._getPosition = function () {
      ...
      var y = parseInt(style.top, 10); // clean up 'auto' or other non-integer values
    ...
    Draggabilly.prototype._addTransformPosition = function (style) {
      ...
      var transform = style[transformProperty]; // bail out if value is 'none'
    ...
    Draggabilly.prototype.dragStart = function (event, pointer) {
      ...
      this.setLeftTop();
      this.dragPoint.x = 0;
      this.dragPoint.y = 0; // reset isDragging flag
    ...
    Draggabilly.prototype.measureContainment = function () {
      ...
      var elemRect = this.element.getBoundingClientRect(); // use element if element
    ...
    Draggabilly.prototype.dragEnd = function (event, pointer) {
      ...
      this.isDragging = false; // use top left position when complete
    ...
    } : Draggabilly.prototype.setLeftTop; // ----- staticClick ----- //
