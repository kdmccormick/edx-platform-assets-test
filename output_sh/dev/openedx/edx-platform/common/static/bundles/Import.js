(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([5],{
      ...
      $('#fileupload').fileupload({
        ...
        progressall: function progressall(e, data) {
          var percentInt = data.loaded / data.total * 100,
              ...
              doneAt; // Firefox makes ProgressEvent.loaded equal ProgressEvent.total only
          ...
          if (percentInt >= doneAt) {
            $bar.hide(); // Start feedback with delay so that current stage of
...
(function (factory) {
  ...
  $.support.blobSlice = window.Blob && (Blob.prototype.slice || Blob.prototype.webkitSlice || Blob.prototype.mozSlice); // The fileupload widget listens for change events on file input fields defined
  ...
  $.widget('blueimp.fileupload', {
    ...
    _initDataAttributes: function _initDataAttributes() {
      var that = this,
          options = this.options; // Initialize options set via HTML5 data-attributes:
